<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo asset('assets/list_cand/bootstrap/css/bootstrap.min.css');?>">
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Francois+One&amp;display=swap">
        <link rel="stylesheet" href="<?php echo asset('assets/list_cand/fonts/fontawesome-all.min.css');?>">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/aos/2.3.4/aos.css">
        <link rel="stylesheet" href="<?php echo asset('assets/list_cand/css/styles.css');?>">
    </head>
<body>
<nav class="navbar navbar-dark fixed-top bg-dark" data-aos="fade" style="background: var(--bs-gray);">
    ...
    <div class="container" data-aos="fade-up" data-aos-duration="600" style="margin-top: 10%;">
        <div class="row">
            <div class="col">
                <h1 style="font-size: 25px;text-align: center;font-family: 'Francois One', sans-serif;margin-top: 15px;"><a href="{{url('/retour')}}/{{$idannonce}}" style="background: rgba(108,117,125,0);border-style: none;color: #000000;"><i class="far fa-arrow-alt-circle-left"></i></a><br>Liste des embauches</h1>
                    ...
                    <table class="table">
                        ...
                        @foreach($liste_embauche as $rows)
                            <tr>
                                <td>{{ $rows->nom }}</td>
                                <td> {{ $rows->prenom }}</td>
                                <td><a class="btn btn-primary" href="{{url('/a_poste')}}/{{$rows->idcandidat}}/{{$idannonce}}" style="background: var(--bs-gray);border-style: none;border-radius: 5px;"><i class="fas fa-list-ol">Attribuer poste</i></a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
    ...
    <script src="<?php echo asset('assets/list_cand/bootstrap/js/bootstrap.min.js');?>"></script>
    <script src="<?php echo asset('assets/list_cand/js/bs-init.js');?>"></script>
