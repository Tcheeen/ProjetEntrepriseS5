...
<head>
    ...
    <link rel="stylesheet" href="<?php echo asset('assets/eval_embauche/bootstrap/css/bootstrap.min.css');?>">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/aos/2.3.4/aos.css">
    <link rel="stylesheet" href="<?php echo asset('assets/eval_embauche/css/styles.css');?>">
</head>
...
<body>
    ...
    <div class="container" data-aos="fade-up" data-aos-duration="600" style="margin-top: 20%;">
        <div class="row">
            <div class="col">
                <h1 style="font-size: 20px;text-align: center;font-family: 'Francois One', sans-serif;margin-top: 15px;">{{ $note_finale }}</h1>
                <h1 style="font-size: 20px;text-align: center;font-family: 'Francois One', sans-serif;margin-top: 15px;">{{ $dur }}</h1>
            </div>
        </div>
    </div>
    ...
    <script src="<?php echo asset('assets/eval_embauche/bootstrap/js/bootstrap.min.js');?>"></script>
    <script src="<?php echo asset('assets/eval_embauche/js/bs-init.js');?>"></script>
