...
<body>
    ...
    <div class="container" data-aos="fade-up" data-aos-duration="600" style="margin-top: 20%;">
        <div class="row">
            <div class="col">
                <h1 style="font-size: 20px;text-align: center;font-family: 'Francois One', sans-serif;margin-top: 15px;">Sur cette annonce {{ $idannonce }}, le candidat {{ $idcandidat }} a eu ce poste avec une note {{ $note }}</h1>
            </div>
        </div>
    </div>
