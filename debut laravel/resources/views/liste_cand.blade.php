...
<nav class="navbar navbar-dark fixed-top bg-dark" data-aos="fade" style="background: var(--bs-gray);">
    ...
    <div class="container" data-aos="fade-up" data-aos-duration="600" style="margin-top: 10%;">
        <div class="row">
            <div class="col">
                <h1 style="font-size: 25px;text-align: center;font-family: 'Francois One', sans-serif;margin-top: 15px;"><a href="{{url('/retour')}}/{{$idannonce}}" style="background: rgba(108,117,125,0);border-style: none;color: #000000;"><i class="far fa-arrow-alt-circle-left"></i></a><br>Liste des candidats</h1>
                    ...
                    <table class="table">
                        ...
                        @foreach($liste as $rows)
                            <tr>
                                ...
                                <td>{{ $rows->nom }}</td>
                                <td> {{ $rows->prenom }}</td>
                                <td><a class="btn btn-primary" href="{{url('/ajout_note')}}/{{ $rows->idcandidat }}/{{ $idannonce }}" style="background: var(--bs-gray);border-style: none;border-radius: 5px;"><i class="fas fa-list-ol"></i></a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
